...
# - plus lent qu'un modèle PLNE frontal à temps continue pour une fonction 
#   de coût linéaire
...
#     #[p] = \sum(t*y[p,t] \forall  t in [lb_min,ub_max]
#   
...
# ### L'objectif
#
#  Minimiser le coût de pénalité total (C = total_cost)
#
# ### Les contraintes
#
...
#
#
# Contrainte de séparation entre tout couple p1 et p2
# Principe :
...
#
# \forall p1 \in P, \forall p2 \in P  | p1.id < p2.id
#         y[p1, t_i] + y[p2, t_j] <= 1
